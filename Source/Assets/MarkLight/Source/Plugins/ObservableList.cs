...
namespace MarkLight
{
    ...
    public class ObservableList<T> : IObservableList, IEnumerable<T>
    {
        ...
        public void Add(T item)
        {
            ...
            if (ListChanged != null)
            {
                ListChanged(this, new ListChangedEventArgs { ListChangeAction = ListChangeAction.Add, StartIndex = index, EndIndex = index });
            }
        }
        ...
        public void Clear()
        {
            if (_list.Count > 0)
            {
                ...
                if (ListChanged != null)
                {
                    ListChanged(this, new ListChangedEventArgs { ListChangeAction = ListChangeAction.Clear });
                }
            }
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            if (ListChanged != null)
            {
                ListChanged(this, new ListChangedEventArgs { ListChangeAction = ListChangeAction.Remove, StartIndex = index, EndIndex = index });
            }
        }
        ...
        public void RemoveRange(int startIndex, int count)
        {
            ...
            if (ListChanged != null)
            {
                ListChanged(this, new ListChangedEventArgs { ListChangeAction = ListChangeAction.Remove, StartIndex = startIndex, EndIndex = endIndex });
            }
        }
        ...
        public void Reverse()
        {
            ...
            if (ListChanged != null)
            {
                ListChanged(this, new ListChangedEventArgs { ListChangeAction = ListChangeAction.Move });
            }
        }
